...
<main class="site-main">
    ...
    <header class="archive-header">
        <h1 class="archive-header__title">税理士サービス一覧</h1>
        <p class="archive-header__description">
            あなたに最適な税理士サービスを見つけましょう
        </p>
    </header>
    ...
    <div class="service-filter">
        <form method="get" action="<?php echo esc_url(get_services_archive_url()); ?>" class="service-filter__form">
            ...
            <div class="service-filter__row">
                <!-- 並び順 -->
                <div class="service-filter__sort">
                ...
                <div class="service-filter__actions">
                    <button type="submit" class="service-filter__button service-filter__button--submit">
                        検索する
                    </button>
                    <a href="<?php echo esc_url(get_services_archive_url()); ?>" class="service-filter__button service-filter__button--reset">
                        条件をクリア
                    </a>
                </div>
            </div>
    ...
    <div class="service-archive">
        ...
        ?>
            ...
            <div class="service-archive__count">
                <p><?php echo esc_html($services_query->found_posts); ?>件のサービスが見つかりました</p>
            </div>
    ...
    ?>
        <section class="service-archive__featured">
            <h2 class="service-archive__section-title">注目の税理士サービス</h2>
            <div class="service-cards">
